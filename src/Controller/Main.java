...
public class Main extends Application{
    ...
    public void start(Stage stage1){
        Ellipse cible = new Ellipse(395,215,25,25);
        Rectangle tourCible = new Rectangle(330,150,130,130);
        tourCible.setOpacity(0);
        Ellipse cible2 = new Ellipse(150,150,25,25);
        Rectangle info = new Rectangle(0,0,800,500);
        info.setOpacity(0.5);
       ...
       /* PointLight light = new PointLight(Color.rgb(0,204,204));
        ...
        tourCible.setOnMouseClicked(event -> {
            ...
            root[1].getChildren().add(controle.Visée(positionX-245,positionY-65+(controle.Gravité(10,10,0))));
            root[0].getChildren().setAll(murGauche/*,light*/,murDroit,toit,table,cible,piedsChaiseGauche,piedsChaiseDroit, controle.Visée((positionX),positionY+(controle.Gravité(10,10,0))),tourCible);
        });
    }
